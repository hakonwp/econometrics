...
```{r}
ggp <- ggpairs(hollywood[,c("openinggross", "budget", "openingtheaters", "criticsopinion")])
...
model5 <- lm(openinggross ~ budget + sequel + criticsopinion + openingtheaters + sumhol + criseq + openingtheaters2, data = hollywood) #w/o  knownstory + opensummer + openholiday + openchristmas + comedy
